export const COMMAND = {
    ...
    items: [
        ...
        { name: "temperature_zero", type: "Real", offset: 224, length: 32, init_value: 0 }, // 零点值
        { name: "temperature_span", type: "Real", offset: 256, length: 32, init_value: 100 }, // 量程值
        { name: "temperature_AH", type: "Real", offset: 288, length: 32, init_value: 0 }, // 高高值
        { name: "temperature_WH", type: "Real", offset: 320, length: 32, init_value: 0 }, // 高值
        { name: "temperature_WL", type: "Real", offset: 352, length: 32, init_value: 0 }, // 低值
        { name: "temperature_AL", type: "Real", offset: 384, length: 32, init_value: 0 }, // 低低值
        ...
        { name: "pressure_zero_raw", type: "Int", offset: 480, length: 16, init_value: 0 }, // 模块原始零点值
        { name: "pressure_span_raw", type: "Int", offset: 496, length: 16, init_value: 27648 }, // 模块原始量程值
        { name: "pressure_underflow", type: "Int", offset: 512, length: 16, init_value: -500 }, // 模块下溢出设置值
        { name: "pressure_overflow", type: "Int", offset: 528, length: 16, init_value: 28000 }, // 模块上溢出设置值
